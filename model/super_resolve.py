...
flags.DEFINE_string('checkpoint_dir', 'results/64-32-3_9-5-5_50', 'Checkpoint directory.')
flags.DEFINE_string('image_file', 'hr.png', 'Sample image file.')
...
for j in range(1):
  hr = cv2.resize(hr, (0, 0), fx=8, fy=8, interpolation=cv2.INTER_CUBIC)
  new = hr.copy()
